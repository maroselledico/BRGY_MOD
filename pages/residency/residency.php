                                    ...
                                    <table id="table" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            if(!isset($_SESSION['staff']))
                                            {
                                                ...
                                                $squery = mysqli_query($con, "SELECT *,CONCAT(rt.lname, ', ' ,rt.fname, ' ' ,rt.mname) as residentname,ry.id as pid FROM tblresidency ry left join tblresident rt on rt.id = ry.residentid where status = 'New'") or die('Error: ' . mysqli_error($con));
                                    ...
                                    <table id="table" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            if(!isset($_SESSION['staff']))
                                            {
                                                ...
                                                $squery = mysqli_query($con, "SELECT *,CONCAT(rt.lname, ', ' ,rt.fname, ' ' ,rt.mname) as residentname,ry.id as pid FROM tblresidency ry left join tblresident rt on rt.id = ry.residentid where status = 'Approved'") or die('Error: ' . mysqli_error($con));
                                                while($row = mysqli_fetch_array($squery))
                                                {
                                                    echo '
                                                    <tr>
                                    ...
                                    <table id="table1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            if(!isset($_SESSION['staff']))
                                            {
                                                ...
                                                $squery = mysqli_query($con, "SELECT *,CONCAT(rt.lname, ', ' ,rt.fname, ' ' ,rt.mname) as residentname,ry.id as pid FROM tblresidency ry left join tblresident rt on rt.id = ry.residentid where status = 'Disapproved' ") or die('Error: ' . mysqli_error($con));
                                                while($row = mysqli_fetch_array($squery))
                                                {
                                                    echo '
                                                    <tr>
                            ...
                            <div class="box">
                                ...
                                <div class="tab-content">
                                    ...
                                    <table id="table" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            $squery = mysqli_query($con, "SELECT * FROM tblresidency ry left join tblresident rt on rt.id = ry.residentid where rt.id = ".$_SESSION['userid']." and status = 'New' ") or die('Error: ' . mysqli_error($con));
                                    ...
                                    <table id="table" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            $squery = mysqli_query($con, "SELECT * FROM tblresidency ry left join tblresident rt on rt.id = ry.residentid where rt.id = ".$_SESSION['userid']." and status = 'Approved'  ") or die('Error: ' . mysqli_error($con));
                                            if(mysqli_num_rows($squery) > 0)
                                            {
                                                while($row = mysqli_fetch_array($squery))
                                                {
                                    ...
                                    <table id="table" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            $squery = mysqli_query($con, "SELECT * FROM tblresidency ry left join tblresident rt on rt.id = ry.residentid where rt.id = ".$_SESSION['userid']." and status = 'Disapproved'  ") or die('Error: ' . mysqli_error($con));
                                            if(mysqli_num_rows($squery) > 0)
                                            {
                                                while($row = mysqli_fetch_array($squery))
                                                {
