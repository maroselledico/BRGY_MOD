...
<div class="container-fluid" style="width: 100%; background: orange; color: white; text-align: center;">
      <h2>BARANGAY OFFICIALS</h2>
  <!--<img class="text-center" src="../img/brgy55.png"/>
  <style>
    .text-center {
      display: block;
      margin: auto;
              ...
              <div class="container">
                <ul class="list-group list-group-flush">
                  <li class="list-group-item">
                    <h4>
                      <img src="../img/brgy55.png" width="64px">
                      <?php echo $row["completeName"]. " - " . $row["sPosition"];?>
                    </h4>
                  </li>
                </ul>
              </div>
